(function (root, factory) {
  ...
  var definitions = [
    {
      code:"narocnina",
      meta:{ title:"Preverite sklenjene pogodbe", summaryTitle:"Pregled naročnine", intro:"Preverimo stroške, uporabo, trajanje in varen izstop.", placeholder:"Npr. Naročnino plačujem mesečno, cena se je zvišala in ne vem, kdaj jo lahko odpovem …", primary:"Sestavi pregled", overviewTitle:"Kaj naj preverimo pri naročnini?", status:"Izberite področje naročnine ali Ateni opišite težavo.", formDescription:"Preverite ključne podatke naročnine.", stepHelper:"da naročnino bolje razumemo.", accent:"#318fdd", tint:"#eff6fc" },
      areas:[
      ...
      fields:[
        ...
        [16123,6107,"zacetek","Od kdaj imate to pogodbo?","date",0,"Datum sklenitve; če točnega ne veste, izberite Približno ali Ne vem"],
    ...
    {
      code:"ponudbe",
      meta:{ title:"Poiščite mi ponudbe", summaryTitle:"Načrt pridobivanja ponudb", intro:"Pripravimo jasno povpraševanje in merila za primerjavo.", placeholder:"Npr. Potrebujem tri primerljive ponudbe za novo spletno stran do konca oktobra …", primary:"Sestavi povpraševanje", overviewTitle:"Kaj potrebujemo za ponudbe?", status:"Izberite področje povpraševanja ali opišite potrebo.", formDescription:"Dopolnite ključne podatke za povpraševanje.", stepHelper:"da bolje razumemo vaše potrebe.", accent:"#159f9b", tint:"#eef9f7" },
      areas:[
