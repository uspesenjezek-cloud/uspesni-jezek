...
(function (root) {
  ...
  var IKONE = {
    ...
    coinCheck: '<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round"><circle cx="9.5" cy="11.5" r="7.5"/><path d="M12.8 7.8a4.3 4.3 0 1 0 0 7.4M6.2 10.1h5.7M6.2 12.8h5.2"/><circle cx="18" cy="17" r="4" fill="white"/><path d="m16.4 17 1.1 1.1 2.2-2.3"/></svg>',
    ...
    handshake: '<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round"><circle cx="10" cy="10" r="7"/><path d="M10 6v4l2.5 1.5"/><circle cx="18" cy="17" r="4" fill="white"/><path d="m16.4 17 1.1 1.1 2.2-2.3"/></svg>',
