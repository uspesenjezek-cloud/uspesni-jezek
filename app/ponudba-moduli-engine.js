(function (root, factory) {
  ...
  var MODULI = [
    ...
    [4003,"C03","Oblika sodelovanja","Osnovni odnos, pogodbeni režim in način obračuna"],
    ...
    [4009,"P01","Enkratna cena","Znesek, valuta in DDV","pogodbe-stej-ponovi-sestej"],
    ...
    [4021,"G02","Podpora in odzivni roki","Odziv, odprava in dosegljivost"],
  ...
  var MODUL_VPRASANJA = Object.freeze({
    ...
    C01:"Kakšna je vloga osebe ali podjetja, ki vam je poslalo ponudbo?",
    C02:"Kako in od koga ste prejeli ponudbo?",
    C03:"Kakšna je osnovna oblika sodelovanja in kateri dodatni režimi veljajo?",
    ...
    R02:"Ali bo ponudnik vključil podizvajalce in od katerih predpogojev je izvedba odvisna?",
  ...
  var POLJA = [
    ...
    [5003,4003,"osnovni-odnos","Kaj najbolje opiše osnovni odnos","select",1,"Izberite eno osnovno obliko; dodatne režime označite spodaj.","nakup:Enkratni nakup|projekt:Posamezen projekt|redno:Redno sodelovanje"],
    [5004,4003,"narocnina-pogodba","Naročnina ali daljša pogodba","select",1,"Ali ta režim velja poleg osnovne oblike?","da:Da|ne:Ne|ni-naveden:Ni navedeno"],
    [5005,4003,"najem","Najem","select",1,"Ali ponudba vključuje najem opreme, prostora ali pravice uporabe?","da:Da|ne:Ne|ni-naveden:Ni navedeno"],
    [5006,4003,"obracun-po-porabi","Plačilo po porabi","select",1,"Ali je del cene odvisen od dejanske porabe ali uporabe?","da:Da|ne:Ne|ni-naveden:Ni navedeno"],
  ...
  var modules = freezeRows(MODULI, function (r) { return { id:r[0], code:r[1], label:r[2], description:r[3], question:MODUL_VPRASANJA[r[1]]||r[2], kombinacijaId:r[4]||null }; });
