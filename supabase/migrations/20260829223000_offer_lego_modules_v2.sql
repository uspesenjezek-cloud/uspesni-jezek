...
(4003,'c03','Oblika sodelovanja','Osnovni odnos, pogodbeni režim in način obračuna',4),
...
(5003,4003,'osnovni-odnos','Kaj najbolje opiše osnovni odnos','select',true,'Izberite eno osnovno obliko; dodatni režimi so ločeni spodaj.','[{"id":"nakup","label":"Enkratni nakup"},{"id":"projekt","label":"Posamezen projekt"},{"id":"redno","label":"Redno sodelovanje"}]',1),
(5004,4003,'narocnina-pogodba','Naročnina ali daljša pogodba','select',true,'','[{"id":"da","label":"Da"},{"id":"ne","label":"Ne"},{"id":"ni-naveden","label":"Ni navedeno"}]',2),
(5005,4003,'najem','Najem','select',true,'','[{"id":"da","label":"Da"},{"id":"ne","label":"Ne"},{"id":"ni-naveden","label":"Ni navedeno"}]',3),
(5006,4003,'obracun-po-porabi','Plačilo po porabi','select',true,'','[{"id":"da","label":"Da"},{"id":"ne","label":"Ne"},{"id":"ni-naveden","label":"Ni navedeno"}]',4),
