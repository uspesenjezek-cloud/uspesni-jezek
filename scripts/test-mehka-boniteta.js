...
assert.match(html, /bonitetna-preverba\.css\?v=20260817-reference-flow-v14/);
...
assert.match(bonitetaCss, /\.stran--bonitetna \.boniteta-zajem \{ gap: 10px; margin: -76px 10px 0;/);
