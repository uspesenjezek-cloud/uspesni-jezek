...
assert.match(html, /bonitetna-preverba\.css\?v=20260817-reference-flow-v16/);
...
assert.match(bonitetaCss, /\.stran--bonitetna \.boniteta-hero \{ min-height: 242px;/);
assert.match(bonitetaCss, /\.stran--bonitetna \.boniteta-zajem \{ gap: 10px; margin: -18px 10px 0;/);
