...
assert.match(html, /bonitetna-preverba\.css\?v=20260817-reference-flow-v15/);
...
assert.match(bonitetaCss, /\.stran--bonitetna \.boniteta-hero \{ min-height: 194px;/);
assert.match(bonitetaCss, /\.stran--bonitetna \.boniteta-zajem \{ gap: 10px; margin: -56px 10px 0;/);
