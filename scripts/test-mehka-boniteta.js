...
assert.match(html, /bonitetna-preverba\.css\?v=20260817-reference-flow-v20/);
...
assert.match(bonitetaCss, /\.stran--bonitetna \.boniteta-zajem \{ gap: 8px; margin: -18px 10px 0;/);
assert.match(bonitetaCss, /\.stran--bonitetna \.crif-flow-picker__options \{ grid-template-columns: repeat\(2, minmax\(0, 1fr\)\);/);
assert.match(html, /bonitetna-preverba\.js\?v=20260817-auth-resilience-v23/);
