...
assert.match(html, /bonitetna-preverba\.css\?v=20260817-zdruzeno-v7/);
assert.match(html, /bonitetna-preverba\.js\?v=20260817-network-retry-v19/);
assert.match(html, /boniteta-pro\.css\?v=20260816-profiles-delete-v6/);
assert.match(html, /boniteta-sredisce\.js\?v=20260817-crif-toggle-v7/);
...
assert.strictEqual((html.match(/data-crif-element/g) || []).length, 4);
...
assert.match(html, /Kako želite dodati stranko\?/);
assert.match(html, /Slikaj dokument/);
assert.match(html, /Uvozi račun\/PDF/);
assert.match(html, /Prilepi spletno povezavo/);
