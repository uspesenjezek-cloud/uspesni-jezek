...
assert.match(css, /html\.app-iphone-preview \.pos-work-order-intro \{[^}]*flex-direction: column/);
assert.match(css, /html\.app-iphone-preview \.pos-work-order-list \{[^}]*grid-template-columns: minmax\(0,1fr\)/);
