 ...
 *     focus: 'a' | 'b' | 'c' | '',                  // neobvezno: odprta plošča ob izrisu
 *     onFocusChange: function (k) {}                // neobvezno: obvestilo ob odprtju/zaprtju plošče
 *   });
...
(function (global) {
  ...
  function mount(root, opts) {
    ...
    root.addEventListener('click', function (e) {
      ...
      if (a === 'focus') { focus = focus === el.getAttribute('data-k') ? '' : el.getAttribute('data-k'); if (opts.onFocusChange) opts.onFocusChange(focus); render(); }
      else if (a === 'close') { focus = ''; if (opts.onFocusChange) opts.onFocusChange(focus); render(); }
