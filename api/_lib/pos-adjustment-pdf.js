...
const { safeText, money, dateDE, wrap, drawHeaderSeller, sellerLegalDisclosureLines, embedUnicodeFonts } = require("./pos-pdf");

const GENERATOR_VERSION = "uj-pos-adjustment-pdf-5";
...
async function ustvariKorekcijskiPdf(adjustment) {
  ...
  function addPage(continuation) {
    ...
    drawHeaderSeller(page, seller.legalName, bold, {
      x: PAGE.margin, baseline: PAGE.height - 49, maxWidth: 278,
      preferred: 14, minimum: 8.5, color: COLORS.white
    });
